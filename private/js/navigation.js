$(function(){
	...
	$('.wgst-navigation-item__collection-data').on('click', function(event) {
	...
	$('.wgst-navigation-item__collection-tree').on('click', function(event) {
	...
	$('.wgst-navigation-item__collection-map').on('click', function(event) {
