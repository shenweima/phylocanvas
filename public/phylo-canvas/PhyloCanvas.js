...
var PhyloCanvas = (function() {
    ...
    var Tree = function(div, conf) {
        ...
        /**
         * X axis of the node that is further to the right
    ...
    Branch.prototype = {
        ...
        drawLabel: function() {
            ...
            if(this.tree.nodeAlign && this.tree.treeType == "rectangular") {
              tx = this.tree.nodeMaxX + 3;
              ty = this.centery + f_size/2.5;
            }
        ...
        prerenderers: {
            ...
            rectangular: function(tree, forcedDraw) {
                ...
                for (var i = 0; i < tree.leaves.length; i++) {
                    ...
                    if(tree.leaves[i].centerx > tree.nodeMaxX) {
                      tree.nodeMaxX = tree.leaves[i].centerx;
                    }
