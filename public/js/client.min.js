...
$(function(){
    ...
    $('.assembly-metadata-list-container').on('change', '.assembly-timestamp-input', function(){
        ...
        var $input = $(this),
            ...
            timestampPart = $input.attr('data-timestamp-input');
    ...
    */
    ...
    var setAssemblyMetadataTimestamp = function(sourceFileName, targetFileName) {
        ...
        var $sourceTimestampYearHtml = $('.assembly-metadata-timestamp-year[data-file-id="' + sourceFileName + '"]'),
            sourceTimestampYearValue = $sourceTimestampYearHtml.find('option:selected').val(), 
            $sourceTimestampMonthHtml = $('.assembly-metadata-timestamp-month[data-file-id="' + sourceFileName + '"]'),
            sourceTimestampMonthValue = $sourceTimestampMonthHtml.find('option:selected').val(),
            $sourceTimestampDayHtml = $('.assembly-metadata-timestamp-day[data-file-id="' + sourceFileName + '"]'),
            sourceTimestampDayValue = $sourceTimestampDayHtml.find('option:selected').val(),
        ...
        if (sourceTimestampYearValue !== '-1') {
            //$targetTimestampYearHtml.val(sourceTimestampYearValue);
        ...
        // To do: need to clone list of days
        //$targetTimestampDayHtml.find('option').clone().appendTo($sourceTimestampDayHtml.find('select'));

        if (sourceTimestampDayValue !== '-1') {
            $targetTimestampDayHtml.find('option[value="' + sourceTimestampDayValue + '"]').prop('selected', true);
        }
    ...
    $('.wgst-panel__assembly-upload-metadata').on('click', '.apply-to-all-assemblies-button', function(){
        ...
        var //metadataElementTimestamp = $(this).closest('.assembly-metadata').find('.assembly-sample-datetime-input'), KKK
