...
exports.beginUpload = function (req, res) {
...
exports.getComplete = function(assemblyId, callback) {
...
exports.getMany = function(assemblyIds) {
...
exports.getResistanceProfile = function(assemblyIds, callback) {
  console.log('[WGST] Getting resistance profile for assembly ids: ' + assemblyIds);

  // Prepend PAARSNP_RESULT_ to each assembly id
  var resistanceProfileQueryKeys =
...
exports.getTableData = function(assemblyIds, callback) {
  ...
  couchbaseDatabaseConnections[COUCHBASE_BUCKETS.MAIN].getMulti(assemblyTableQueryKeys, {}, function(error, assemblyTableData) {
    ...
    callback(null, reduceAssemblyTableData(assemblyTableData));
  });
};
